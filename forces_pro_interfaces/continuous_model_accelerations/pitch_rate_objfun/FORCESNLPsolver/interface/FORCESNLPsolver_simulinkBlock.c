...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 630, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 4, 1);
	...
	/* initialize output ports - there are 70 in total */
    if (!ssSetNumOutputPorts(S, 70)) return;    
