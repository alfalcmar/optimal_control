...
cinematography_term = 1000/1001;
w2 = cinematography_term;
accelerations = 1/1001;
w1 = accelerations;

J = w1*(z(1)^2+z(2)^2+z(3)^2) + w2*(((z(8)-p(10))*(z(4)-p(9))-(z(5)-p(10))*(z(7)-p(12)))^2)/(((z(4)-p(9))^2+(z(5)+p(10))^2)^2); % cinematography term
